...
export const dialogueData = {
    ...
    CV: `Here is my CV. You can see it by clicking here: <a href="https://github.com/SamuelSanchezGit/MyResume/blob/main/MyResumeSamuelSanchez.pdf" target="_blank">link to the CV</a>`,
